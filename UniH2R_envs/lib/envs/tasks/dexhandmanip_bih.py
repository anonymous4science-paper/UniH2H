...
class DexHandManipBiHEnv(VecTask):
    ...
    def __init__(
        ...
        *,
        ...
        self._dexhand_rh_effort_limits = None                                        
        self._dexhand_rh_dof_speed_limits = None                                       
        self._global_dexhand_rh_indices = None                                                               
        ...
        self.dexhand_lh_default_dof_pos = torch.tensor(default_pose, device=self.sim_device)                     
    ...
    def compute_observations_side(self, side="rh"):
        ...
        target_wrist_pos = indicing(side_demo_data["wrist_pos"], cur_idx)             
        cur_wrist_pos = side_states["base_state"][:, :3]          
        ...
        cur_joint_pos = side_states["joints_state"][:, 1:, :3]                       
        ...
        cur_joint_vel = side_states["joints_state"][:, 1:, 7:10]                       
    ...
    def set_force_vis(self, env_ptr, part_k, has_force, side):
        self.gym.set_rigid_body_color(
            ...
            getattr(self, f"dexhand_rh_handles")[part_k],                                               
            gymapi.MESH_VISUAL,
            (
                gymapi.Vec3(
                    1.0,
